...
class TestUpdateEventForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: '',
  ...
  render() {
    console.log(this.props.eventToUpdate, 'inside TestUpdateEventForm')
    return (
      <Grid fixed={'center'}>
        <form
...
const StyledTestUpdateEventForm = withStyles(styles)(TestUpdateEventForm);

export default connect(mapStateToProps)(StyledTestUpdateEventForm);